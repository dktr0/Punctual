...
graph3 = asum [
  ...
  reserved "chain" >> return (Chain Combinatorial),
  reserved "chainp" >> return (Chain PairWise),
  reserved "lines" >> return (Lines Combinatorial),
  reserved "linesp" >> return (Lines PairWise),
  reserved "ilines" >> return (ILines Combinatorial),
  reserved "ilinesp" >> return (ILines PairWise),
  reserved "mesh" >> return (Mesh Combinatorial),
  reserved "meshp" >> return (Mesh PairWise),
