...
runBenchmark:
	node benchmark/build/x86_64-linux/ghcjs-8.6.0.1/punctual-0.4.4.5/b/punctual-benchmarks/build/punctual-benchmarks/punctual-benchmarks.jsexe/all.js

runBenchmarkInBrowser:
	open benchmark/build/x86_64-linux/ghcjs-8.6.0.1/punctual-0.4.4.5/b/punctual-benchmarks/build/punctual-benchmarks/punctual-benchmarks.jsexe/index.html
