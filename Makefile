...
devBuild:
	...
	cp -Rf dev-result/build/x86_64-linux/ghcjs-8.6.0.1/punctual-0.4.0.1/x/punctual/build/punctual/punctual.jsexe .
	cp -f style.css punctual.jsexe/style.css
...
runBenchmark:
	node benchmark/build/x86_64-linux/ghcjs-8.6.0.1/punctual-0.4.0.1/b/punctual-benchmarks/build/punctual-benchmarks/punctual-benchmarks.jsexe/all.js

runBenchmarkInBrowser:
	open benchmark/build/x86_64-linux/ghcjs-8.6.0.1/punctual-0.4.0.1/b/punctual-benchmarks/build/punctual-benchmarks/punctual-benchmarks.jsexe/index.html
